            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  ...
                  src="{{asset('assets/images/adherents')}}/{{$image}}"
                       alt="adherent image">
                </div>
                ...
                <a href="{{route('backend.adherents.edit',['id_adherent'=>$id_adherent])}}" class="btn btn-warning btn-block"><b>Modifier</b></a>
                <a href="#" onclick="confirm('Voulez Vous vraiment supprimer cet adherent ?')|| event.stopImmediatePropagation()" 
                wire:click.prevent="deleteAdherent({{$id_adherent}})" class="btn btn-danger btn-block"><b>Supprimer</b></a>
