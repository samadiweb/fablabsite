  <div>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Modification d'une Adherents</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <form wire:submit.prevent="store">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" wire:model="titre" class="form-control" placeholder="Titre de Adherent">
                    @error('titre') <span class="text-danger">{{ $message }}</span> @enderror
                  </div>
                  <div class="form-group">
                    <label for="description">Description</label>

                    <textarea wire:model="description" class="form-control" id="description" placeholder="Description de Adherent"></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="image">Image de Adherent</label>
                    <div class="input-group">
                      ...
                      @error('image') <div> <span class="text-danger">{{ $message }}</span></div> @enderror
                        ...
                        @if($newImage)
                                    ...
                                    @else
                                        <img src="{{asset('assets/images/adherents')}}/{{$image}}" alt="Image" width="120">
                                    @endif
                        </div>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea wire:model="notes" class="form-control" id="notes" placeholder="notes de Adherent"></textarea>
                  </div>
